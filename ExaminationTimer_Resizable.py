...
class Input:
    def __init__(self, frame):
        ...
        # Titles
        exam_title_label = Label(frame, bd=2, relief=GROOVE,
                                 fg=input_titles_text, font=("Arial", 16), text="Exam Title",
                                 bg=self.TITLE_LABEL_BACKGROUND_C)
        exam_time_label = Label(frame, bd=2, relief=GROOVE,
                                fg=input_titles_text, font=("Arial", 16), text="Duration",
                                bg=self.TITLE_LABEL_BACKGROUND_C)
        exam_extra_time_label = Label(frame, bd=2, relief=GROOVE,
        ...
        # Main Time
        exam_one_time = Entry(frame, justify=CENTER, bd=2, relief=GROOVE,
                              font=("Arial", 13), bg=self.TIME_LABEL_BACKGROUND_C, textvariable=self.e1t,
                              fg=input_examination_duration_text)
        exam_two_time = Entry(frame, justify=CENTER, bd=2, relief=GROOVE,
                              font=("Arial", 13), bg=self.TIME_LABEL_BACKGROUND_C, textvariable=self.e2t,
                              fg=input_examination_duration_text)
        exam_three_time = Entry(frame, justify=CENTER, bd=2, relief=GROOVE,
                                font=("Arial", 13), bg=self.TIME_LABEL_BACKGROUND_C, textvariable=self.e3t,
                                fg=input_examination_duration_text)
        exam_four_time = Entry(frame, justify=CENTER, bd=2, relief=GROOVE,
        ...
        # Extra Time
        exam_one_extra_time = Entry(frame, justify=CENTER, bd=2, relief=GROOVE,
                                    font=("Arial", 13), bg=self.EXTRA_TIME_LABEL_BACKGROUND_C, textvariable=self.ee1t,
                                    fg=input_examination_extra_time_text)
        exam_two_extra_time = Entry(frame, justify=CENTER, bd=2, relief=GROOVE,
                                    font=("Arial", 13), bg=self.EXTRA_TIME_LABEL_BACKGROUND_C, textvariable=self.ee2t,
                                    fg=input_examination_extra_time_text)
        exam_three_extra_time = Entry(frame, justify=CENTER, bd=2, relief=GROOVE,
                                      font=("Arial", 13), bg=self.EXTRA_TIME_LABEL_BACKGROUND_C, textvariable=self.ee3t,
                                      fg=input_examination_extra_time_text)
        exam_four_extra_time = Entry(frame, justify=CENTER, bd=2, relief=GROOVE,
        ...
        # Test Beep Button
        allow_voice_sound_button = Button(frame,
                                          text="Voice Sound Disabled",
                                          fg=input_voice_sound_button_text,
                                          bg=input_voice_sound_button_background,
                                          activebackground=input_voice_sound_button_background,
                                          command=lambda: Sounds.change_allow_voice_sounds(allow_voice_sound_button))

        update_config_button = Button(frame,
                                      text="Update Config",
                                      fg=input_voice_sound_button_text,
                                      bg=input_voice_sound_button_background,
                                      activebackground=input_voice_sound_button_background,
        ...
        exit_button = Button(frame,
                             text="Exit Program",
                             fg=input_exit_button_text,
                             bg=input_exit_button_background,
                             activebackground=input_exit_button_background,
                             command=exit_program)

        # Standby Button
        standby_button = Button(frame,
                                text="Standby",
                                fg=input_submit_button_text,
                                bg=input_submit_button_background,
                                activebackground=input_submit_button_background,
        ...
        exam_title_label.grid(sticky=N+S+E+W, row=0, column=0, columnspan=2)
        exam_time_label.grid(sticky=N+S+E+W, row=0, column=2)
        exam_extra_time_label.grid(sticky=N+S+E+W, row=0, column=3)

        exam_one_name.grid(sticky=N+S+E+W, row=1, column=0, columnspan=2)
        exam_two_name.grid(sticky=N+S+E+W, row=2, column=0, columnspan=2)
        exam_three_name.grid(sticky=N+S+E+W, row=3, column=0, columnspan=2)
        exam_four_name.grid(sticky=N+S+E+W, row=4, column=0, columnspan=2)

        exam_one_time.grid(sticky=N+S+E+W, row=1, column=2)
        exam_two_time.grid(sticky=N+S+E+W, row=2, column=2)
        exam_three_time.grid(sticky=N+S+E+W, row=3, column=2)
        exam_four_time.grid(sticky=N+S+E+W, row=4, column=2)

        exam_one_extra_time.grid(sticky=N+S+E+W, row=1, column=3)
        exam_two_extra_time.grid(sticky=N+S+E+W, row=2, column=3)
        exam_three_extra_time.grid(sticky=N+S+E+W, row=3, column=3)
        exam_four_extra_time.grid(sticky=N+S+E+W, row=4, column=3)

        allow_voice_sound_button.grid(sticky=N+S+E+W, row=5, column=0)
        update_config_button.grid(sticky=N+S+E+W, row=5, column=1)

        exit_button.grid(sticky=N+S+E+W, row=5, column=2)

        standby_button.grid(sticky=N+S+E+W, row=5, column=3)
        if __DEBUG__:
            print("Done!")

    def start(self):
        self.frame.grid(sticky=N+S+E+W, row=0, column=1)
...
class SecondScreen:
    def __init__(self, frame):
        ...
        # Titles
        exam_title_label = Label(self.frame, bd=2, relief=GROOVE,
                                 font=("Arial", 16), text="Examination", bg=self.TITLE_LABEL_BACKGROUND_C)
        exam_allowed_time_label = Label(self.frame, bd=2, relief=GROOVE,
                                        font=("Arial", 16), text="Allowed", bg=self.TITLE_LABEL_BACKGROUND_C)
        exam_remaining_time_label = Label(self.frame, bd=2, relief=GROOVE,
                                          font=("Arial", 16), text="Remaining", bg=self.TITLE_LABEL_BACKGROUND_C)
        exam_start_time_label = Label(self.frame, bd=2, relief=GROOVE,
                                      font=("Arial", 16), text="Start Time", bg=self.TITLE_LABEL_BACKGROUND_C)
        exam_end_time_label = Label(self.frame, bd=2, relief=GROOVE,
                                    font=("Arial", 16), text="End Time", bg=self.TITLE_LABEL_BACKGROUND_C)
        exam_end_extra_time_label = Label(self.frame, bd=2, relief=GROOVE,
                                          font=("Arial", 16), text="Plus Extra", bg=self.TITLE_LABEL_BACKGROUND_C)

        # Exam Name
        self.exam_one_name = Label(self.frame, bd=2, relief=GROOVE,
                                   font=("Arial", 14), text="", bg=self.NAME_LABEL_BACKGROUND_C)
        self.exam_two_name = Label(self.frame, bd=2, relief=GROOVE,
                                   font=("Arial", 14), text="", bg=self.NAME_LABEL_BACKGROUND_C)
        self.exam_three_name = Label(self.frame, bd=2, relief=GROOVE,
                                     font=("Arial", 14), text="", bg=self.NAME_LABEL_BACKGROUND_C)
        self.exam_four_name = Label(self.frame, bd=2, relief=GROOVE,
                                    font=("Arial", 14), text="", bg=self.NAME_LABEL_BACKGROUND_C)

        # Main Time
        self.exam_one_time = Label(self.frame, bd=2, relief=GROOVE,
                                   font=("Arial", 13), text="", bg=self.ALLOWED_TIME_LABEL_BACKGROUND_C,
                                   fg=examination_allowed_time_text)
        self.exam_two_time = Label(self.frame, bd=2, relief=GROOVE,
                                   font=("Arial", 13), text="", bg=self.ALLOWED_TIME_LABEL_BACKGROUND_C,
                                   fg=examination_allowed_time_text)
        self.exam_three_time = Label(self.frame, bd=2, relief=GROOVE,
                                     font=("Arial", 13), text="", bg=self.ALLOWED_TIME_LABEL_BACKGROUND_C,
                                     fg=examination_allowed_time_text)
        self.exam_four_time = Label(self.frame, bd=2, relief=GROOVE,
                                    font=("Arial", 13), text="", bg=self.ALLOWED_TIME_LABEL_BACKGROUND_C,
                                    fg=examination_allowed_time_text)

        # Timers
        self.exam_one_remaining_time = Label(self.frame, bd=2, relief=GROOVE,
                                             font=("Arial", 13), text="", bg=self.REMAINING_TIME_LABEL_BACKGROUND_C,
                                             fg=examination_remaining_time_text)
        self.exam_two_remaining_time = Label(self.frame, bd=2, relief=GROOVE,
                                             font=("Arial", 13), text="", bg=self.REMAINING_TIME_LABEL_BACKGROUND_C,
                                             fg=examination_remaining_time_text)
        self.exam_three_remaining_time = Label(self.frame, bd=2, relief=GROOVE,
                                               font=("Arial", 13), text="", bg=self.REMAINING_TIME_LABEL_BACKGROUND_C,
                                               fg=examination_remaining_time_text)
        self.exam_four_remaining_time = Label(self.frame, bd=2, relief=GROOVE,
                                              font=("Arial", 13), text="", bg=self.REMAINING_TIME_LABEL_BACKGROUND_C,
                                              fg=examination_remaining_time_text)

        # Start time
        self.exam_one_start_time = Label(self.frame, bd=2, relief=GROOVE,
                                         font=("Arial", 13), text="", bg=self.START_TIME_LABEL_BACKGROUND_C,
                                         fg=examination_start_time_text)
        self.exam_two_start_time = Label(self.frame, bd=2, relief=GROOVE,
                                         font=("Arial", 13), text="", bg=self.START_TIME_LABEL_BACKGROUND_C,
                                         fg=examination_start_time_text)
        self.exam_three_start_time = Label(self.frame, bd=2, relief=GROOVE,
                                           font=("Arial", 13), text="", bg=self.START_TIME_LABEL_BACKGROUND_C,
                                           fg=examination_start_time_text)
        self.exam_four_start_time = Label(self.frame, bd=2, relief=GROOVE,
                                          font=("Arial", 13), text="", bg=self.START_TIME_LABEL_BACKGROUND_C,
                                          fg=examination_start_time_text)

        # Normal Time End Time
        self.exam_one_end_time = Label(self.frame, bd=2, relief=GROOVE,
                                       font=("Arial", 13), text="", bg=self.END_TIME_LABEL_BACKGROUND_C,
                                       fg=examination_end_time_text)
        self.exam_two_end_time = Label(self.frame, bd=2, relief=GROOVE,
                                       font=("Arial", 13), text="", bg=self.END_TIME_LABEL_BACKGROUND_C,
                                       fg=examination_end_time_text)
        self.exam_three_end_time = Label(self.frame, bd=2, relief=GROOVE,
                                         font=("Arial", 13), text="", bg=self.END_TIME_LABEL_BACKGROUND_C,
                                         fg=examination_end_time_text)
        self.exam_four_end_time = Label(self.frame, bd=2, relief=GROOVE,
                                        font=("Arial", 13), text="", bg=self.END_TIME_LABEL_BACKGROUND_C,
                                        fg=examination_end_time_text)

        # Extra Time End Time
        self.exam_one_extra_end_time = Label(self.frame, bd=2, relief=GROOVE,
                                             font=("Arial", 13), text="", bg=self.EXTRA_END_TIME_LABEL_BACKGROUND_C,
                                             fg=examination_end_plus_extra_time_text)
        self.exam_two_extra_end_time = Label(self.frame, bd=2, relief=GROOVE,
                                             font=("Arial", 13), text="", bg=self.EXTRA_END_TIME_LABEL_BACKGROUND_C,
                                             fg=examination_end_plus_extra_time_text)
        self.exam_three_extra_end_time = Label(self.frame, bd=2, relief=GROOVE,
                                               font=("Arial", 13), text="", bg=self.EXTRA_END_TIME_LABEL_BACKGROUND_C,
                                               fg=examination_end_plus_extra_time_text)
        self.exam_four_extra_end_time = Label(self.frame, bd=2, relief=GROOVE,
                                              font=("Arial", 13), text="", bg=self.EXTRA_END_TIME_LABEL_BACKGROUND_C,
                                              fg=examination_end_plus_extra_time_text)

        # Clock Label
        self.clock_label = Label(self.frame, bd=2, relief=GROOVE,
                                 font=("Arial", 14), text="", bg=digital_background_colour, fg=digital_text_colour)

        # Exit Button
        self.exit_button = Button(self.frame, text="Close Program", fg=exit_button_text, bg=exit_button_background,
                                  command=exit_program)

        # Start All Button
        self.start_all_button = Button(self.frame, text="Start All", bg=restart_button_background,
                                       fg=restart_button_text,
                                       activebackground=restart_button_background,
                                       command=self.start_all)

        self.restart_button = Button(self.frame, text="Restart", bg='#FF0000', activebackground='#FF0000',
                                     command=self.restart)

        # Pause All Button
        self.pause_all_button = Button(self.frame, text="Pause All", bg=pause_all_button_background,
                                       fg=pause_all_button_text,
                                       activebackground=pause_all_button_active_background,
                                       command=self.pause_all)

        # Individual Start Buttons
        self.start_button_e1 = Button(self.frame, text="Start",
                                      fg=examination_start_button_text,
                                      bg=examination_start_button_background,
                                      activebackground=examination_start_button_active_background,
                                      command=self.start_e1)
        self.start_button_e2 = Button(self.frame, text="Start",
                                      fg=examination_start_button_text,
                                      bg=examination_start_button_background,
                                      activebackground=examination_start_button_active_background,
                                      command=self.start_e2)
        self.start_button_e3 = Button(self.frame, text="Start",
                                      fg=examination_start_button_text,
                                      bg=examination_start_button_background,
                                      activebackground=examination_start_button_active_background,
                                      command=self.start_e3)
        self.start_button_e4 = Button(self.frame, text="Start",
                                      fg=examination_start_button_text,
                                      bg=examination_start_button_background,
                                      activebackground=examination_start_button_active_background,
        ...
        exam_title_label.grid(sticky=N+S+E+W, row=0, column=0, columnspan=2)
        exam_allowed_time_label.grid(sticky=N+S+E+W, row=0, column=2)
        exam_remaining_time_label.grid(sticky=N+S+E+W, row=0, column=3)
        exam_start_time_label.grid(sticky=N+S+E+W, row=0, column=4)
        exam_end_time_label.grid(sticky=N+S+E+W, row=0, column=5)
        exam_end_extra_time_label.grid(sticky=N+S+E+W, row=0, column=6)

        self.clock_label.grid(sticky=N+S+E+W, row=5, column=4, columnspan=2)
        ...
        self.canvas.grid(sticky=N+S+E+W, row=0, column=7, rowspan=6)
    ...
    def start(self):
        ...
        if one_has_data:
            ...
            self.exam_one_name.grid(sticky=N+S+E+W, row=1, column=0, columnspan=2)
            self.exam_one_time.configure(text=e1tc)
            self.exam_one_time.grid(sticky=N+S+E+W, row=1, column=2)
            self.exam_one_remaining_time.grid(sticky=N+S+E+W, row=1, column=3)
            self.exam_one_start_time.grid(sticky=N+S+E+W, row=1, column=4)
            self.exam_one_end_time.grid(sticky=N+S+E+W, row=1, column=5)
            self.start_button_e1.grid(sticky=N+S+E+W, row=1, column=3)
            if one_has_extra_time:
                self.exam_one_extra_end_time.grid(sticky=N+S+E+W, row=1, column=6)
        else:
        ...
        if two_has_data:
            ...
            self.exam_two_name.grid(sticky=N+S+E+W, row=2, column=0, columnspan=2)
            self.exam_two_time.configure(text=e2tc)
            self.exam_two_time.grid(sticky=N+S+E+W, row=2, column=2)
            self.exam_two_remaining_time.grid(sticky=N+S+E+W, row=2, column=3)
            self.exam_two_start_time.grid(sticky=N+S+E+W, row=2, column=4)
            self.exam_two_end_time.grid(sticky=N+S+E+W, row=2, column=5)
            self.start_button_e2.grid(sticky=N+S+E+W, row=2, column=3)
            if two_has_extra_time:
                self.exam_two_extra_end_time.grid(sticky=N+S+E+W, row=2, column=6)
        else:
        ...
        if three_has_data:
            ...
            self.exam_three_name.grid(sticky=N+S+E+W, row=3, column=0, columnspan=2)
            self.exam_three_time.configure(text=e3tc)
            self.exam_three_time.grid(sticky=N+S+E+W, row=3, column=2)
            self.exam_three_remaining_time.grid(sticky=N+S+E+W, row=3, column=3)
            self.exam_three_start_time.grid(sticky=N+S+E+W, row=3, column=4)
            self.exam_three_end_time.grid(sticky=N+S+E+W, row=3, column=5)
            self.start_button_e3.grid(sticky=N+S+E+W, row=3, column=3)
            if three_has_extra_time:
                self.exam_three_extra_end_time.grid(sticky=N+S+E+W, row=3, column=6)
        else:
        ...
        if four_has_data:
            ...
            self.exam_four_name.grid(sticky=N+S+E+W, row=4, column=0, columnspan=2)
            self.exam_four_time.configure(text=e4tc)
            self.exam_four_time.grid(sticky=N+S+E+W, row=4, column=2)
            self.exam_four_remaining_time.grid(sticky=N+S+E+W, row=4, column=3)
            self.exam_four_start_time.grid(sticky=N+S+E+W, row=4, column=4)
            self.exam_four_end_time.grid(sticky=N+S+E+W, row=4, column=5)
            self.start_button_e4.grid(sticky=N+S+E+W, row=4, column=3)
            if four_has_extra_time:
                self.exam_four_extra_end_time.grid(sticky=N+S+E+W, row=4, column=6)
        else:
        ...
        if one_has_data and (two_has_data or three_has_data or four_has_data):
            self.start_all_button.grid(sticky=N+S+E+W, row=5, column=2)

        self.pause_all_button.grid(sticky=N+S+E+W, row=5, column=3)
    ...
    def multi_updater(self):
        ...
        if number_of_completed_exams >= number_of_exams and self.allow_completed_exam_code:
            ...
            try:
                self.exit_button.grid(sticky=N+S+E+W, row=5, column=2)
                self.restart_button.grid(sticky=N+S+E+W, row=5, column=3)
            except TclError:
                if __DEBUG__:
    ...
    def pause_all(self):
        ...
        # Else if all_paused is false, set it to true, display pause buttons
            ...
            self.exit_button.grid(sticky=N+S+E+W, row=5, column=0)
            self.restart_button.grid(sticky=N+S+E+W, row=5, column=1)
...
if __name__ == '__main__':
    if allow_launch:
        ...
        logo_frame.grid(sticky=N+S+E+W)

        for x in range(1):
            Grid.columnconfigure(logo_frame, x, weight=1)

        for y in range(3):
            Grid.rowconfigure(logo_frame, y, weight=1)

        # Licence holder label
        Label(logo_frame, bg=main_bg, text=str(LICENCE_HOLDER_LONG)).grid(sticky=N+S+E+W, row=0)
        ...
        try:
            ...
            logo_label.grid(sticky=N+S+E+W, row=1)
        except TclError:
            if __DEBUG__:
        ...
        # Author Label
        Label(logo_frame, bg=main_bg, text=format("© %s GCN Software" % __AUTHOR__)).grid(sticky=N+S+E+W, row=2)
        ...
        Label(root, text="Enter Key Here:").grid(sticky=N+S+E+W)
        Entry(root, textvariable=entry_key_holder).grid(sticky=N+S+E+W)
        Button(root, text="Submit", command=lambda: sys.exit(set_reg_info(entry_key_holder))).grid(sticky=N+S+E+W)
        if __DEBUG__:
